...
class ThreadAgent:
    ...
    def __init__(self) -> None:
        ...
        self.topic_keywords = {
            "pricing": [
                "price", "cost", "budget", "expensive", "cheap", "pricing", "fee"
            ],
            "technical": [
                "code", "programming", "bug", "error", "development", "software"
            ],
            "business": [
                "strategy", "revenue", "growth", "market", "customer", "sales"
            ],
            "data_analysis": [
                "data", "analytics", "metrics", "dashboard", "report", "insights"
            ],
            "project_management": [
                "project", "deadline", "timeline", "milestone", "task", "planning"
            ],
            "customer_support": [
                "support", "help", "issue", "problem", "ticket", "complaint"
            ],
            "machine_learning": [
                "ml", "ai", "model", "training", "prediction", "algorithm"
            ]
        }
...
Remember: Your goal is to create meaningful connections between ideas and help users progress their thinking."""
    ...
    def _get_groq_client(self) -> Optional[Groq]:
        """
        Get Groq client dynamically when needed.
    ...
    async def process_message(self, message: str) -> Tuple[str, str]:
        ...
        try:
            ...
            self.conversation_history.append(
                format_chat_message("assistant", response)
            )
